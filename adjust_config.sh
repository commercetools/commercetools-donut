...
sed -i "s;^sphere.clientSecret=.*;pactas.clientId="${PACTAS_CLIENT_ID}";g" "${PLAY_CONF_FILE}"
sed -i "s;^sphere.clientSecret=.*;pactas.clientSecret="${PACTAS_CLIENT_SECRET}";g" "${PLAY_CONF_FILE}"
